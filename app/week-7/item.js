export default function Item({props, removeItem, removeBool}){
    let {id, name, quantity, category, size, emoji} = props;

        return(
        <div className="box-content relative size-32 border-3 border-dotted border-[#DC143C] p-3 m-3 rounded-sm bg-[#FFFFFF]/65">
